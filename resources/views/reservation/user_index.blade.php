        ...
        <table class="table table-striped">
            ...
            @foreach($reservations as $reservation)
                <tr>
                    ...
                    <td><a href="{{ route('show.show', $reservation->representation->show->id)}}">{{ $reservation->representation->show->title }}</a></td>
                    <td><a href="{{ route('location.index')}}">{{ $reservation->representation->location ? $reservation->representation->location->designation : '(Lieu Inconnu)' }}</a></td>
